...
When first starting the application you'll be presented with a login screen.  There are three valid logins, which you 
can press the *Forget Password* link, here they are for your convenience.
  * rashmi  = admin 
  * julian  = admin 
  * johndoe = admin 
...
### Todo List
  After starting the app you'll be presented with a login screen.

- [ ] Saving the user while answering a question is is blocked because the server is bugged. **SERVER BUGGED**.


### Lessons Learned
// Originally I wrote some components using class components, but in the back of my mind
// I knew hooks were a better approach.  After converting a handful, I saw this pattern emerge.

// 1. constructor becomes useState
// 2. componentDidMount becomes useEffect with []
// 3. mapDispatchToProps becomes useDispatch and regular imports
// 4. mapStateToProps becomes useSelector
// 5. Render becomes return
